        ...
        <div class="event-left-column">
            <?php if (!empty($event['poster_image'])): ?>
                <div class="event-image">
                    <img src="<?php echo esc_url($event['poster_image']); ?>" alt="<?php echo esc_attr($event['title']); ?>"
                        loading="lazy">
                </div>
            <?php endif; ?>
                ...
                <div class="event-meta">
                    <div class="meta-item">
                        ...
                        <div>
                            ...
                            <span
                                class="meta-value"><?php echo date('F j, Y, g:i a', strtotime($event['start_date'])); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="meta-item">
                        ...
                        <div>
                            ...
                            <span
                                class="meta-value"><?php echo date('F j, Y, g:i a', strtotime($event['end_date'])); ?></span>
                        </div>
                    </div>
                                        ...
                                        <div class="ticket-actions">
                                            <div class="quantity-selector">
                                                ...
                                                <input type="number" class="ticket-quantity" value="1" min="1"
                                                    max="<?php echo esc_attr($ticket_quantity); ?>">
                                ...
                                <?php foreach ($event['addons'] as $addon): ?>
                                    <div class="ticket-item addon-item">
                                        ...
                                        <div class="ticket-actions">
                                            <div class="quantity-selector">
                                                <button class="quantity-decrease">-</button>
                                                <input type="number" class="ticket-quantity addon-quantity" value="1" min="1"
                                                    max="10">
                                                <button class="quantity-increase">+</button>
                                            </div>
                                            <button class="add-to-cart add-addon-to-cart"
...
<style>
    ...
    .item-details {
        flex: 1;
        min-width: 0;
        /* For text overflow to work in flex child */
    }
